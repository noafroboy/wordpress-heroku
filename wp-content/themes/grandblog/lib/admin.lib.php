...
array( "name" => "<h2>Import Demo Content</h2>",
	...
	"type" => "html",
	"html" => '<strong>*NOTE:</strong> If you import demo content. It will overwrite the existing data and settings. It\'s not included revolution slider and widgets settings so you have to configure that settings once it\'s done.<br/><br/>'.grandblog_check_system().'
	    	...
	    	<div class="item_content_wrapper">
	    		<div class="item_content">
	    			...
	    			<div class="item_content">
				    	...
				    	<a href="http://themes.themegoods2.com/grandblog/">(See Sample)</a><br/><br/>
