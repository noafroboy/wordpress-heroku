...
<div id="social_share_wrapper">
	<ul>
		...
		<li><a class="tooltip" title="<?php esc_html_e( 'Share On Twitter', 'grandblog-translation' ); ?>" target="_blank" href="https://twitter.com/intent/tweet?original_referer=<?php echo get_permalink(); ?>&url=<?php echo get_permalink(); ?>&text=<?php echo "Love this article by @thalamusinc!"; ?>"><i class="fa fa-twitter marginright"></i></a></li>
		...
		<li><a class="tooltip" title="<?php esc_html_e('Share by Email', 'grandblog-translation' ); ?>" href="mailto:?Subject=<?php echo esc_attr($post->post_title); ?>&Body=<?php echo "Check out this article - " . get_permalink(); ?>"><i class="fa fa-envelope marginright"></i></a></li>
	</ul>
</div>