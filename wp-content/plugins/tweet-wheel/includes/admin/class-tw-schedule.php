                ...
                <?php
                    ...
                    if( $this->has_times() ) :
                        ...
                        foreach( $this->get_times() as $time ) :
                            ...
                            $minutes = '';
                            for($i = 0; $i < 60; $minutes .= '<option value="' . $i . '"' . selected( $time['minute'], $i, false ) . '>' . ( strlen( $i ) < 2 ? '0' . $i : $i ) . '</option>', $i += 15);
    ...
    public function time_template_js() {
        ...
        <div class="time-template" style="display:none">
            ...
            <?php
                ...
                $minutes = '';
                for($i = 0; $i < 60; $minutes .= '<option value="' . $i . '">' . ( strlen( $i ) < 2 ? '0' . $i : $i ) . '</option>', $i+=15);
