...
class TW_Queue {
    ...
    public function page() {
		...
		<div class="wrap tweet-wheel tw-queue-page">
            ...
            <aside id="tw-queue-sidebar">
                <div class="tw-sidebar-widget">
                    <h3>Why upgrade to PRO:</h3>
                    <ul>
                        <li>Attach <strong>featured images</strong> to your tweets with one click.</li>
                        <li>Use your favorite domain for <strong>shortening URLs</strong> (by Bit.ly).</li>
                        <li>Tweet on post publish or update.</li>
                        <li>Enjoy the <strong>mobile-friendly</strong> interface.</li>
                        <li><strong>Track clicks</strong> and tweets history of individual tweeted templates.</li>
                        <li>Fill up the queue using <strong>filtering by date range, amount and post type</strong>.</li>
                        <li>Seamless <strong>data migration</strong> to the pro version using built-in importer</li>
                        <li>Plenty minor improvements which overally boost user experience and easy of use.</li>
                        <li>Lifetime upgrades</li>
                        <li><strong>Premium support</strong></li>
                    </ul>
                    <a style="width: 100%;" class="tw-start-button button" href="http://nrdd.co/1LpxHSY" target="_blank">GO PRO</a>
                </div> 
                
                <div class="tw-sidebar-widget">
                    <h3>What's new in Pro 2.0</h3> 
                    <ul>
                        <li>Unlimited queues</li>
                        <li>Precise schedule</li>
                        <li>Live hashtag analytics</li>
                        <li>Real-time feed widget</li>
                        <li>Much more...</li>
                    </ul>
                    <a style="width: 100%;" class="tw-start-button button" href="https://nerdcow.ticksy.com/article/4979/" target="_blank">READ MORE</a>
                </div>   
            </aside>
    ...
    public function get_queued_items() {
        ...
        $results = $wpdb->get_results(
            "SELECT * FROM " . $wpdb->prefix . "tw_queue ORDER BY queue ASC"
        );
    ...
    public function get_last_queued() {
        ...
        $query = $wpdb->get_row(
            "SELECT * FROM " . $wpdb->prefix . "tw_queue ORDER BY queue DESC LIMIT 1"
        );
    ...
    public function get_first_queued_item() {
        ...
        return $wpdb->get_row( "SELECT * FROM " . $wpdb->prefix . "tw_queue ORDER BY queue ASC LIMIT 1" );
